  ...
  router.patch("/:chatId", async (req, res) => {
    try {
      ...
      let sysprompt = `You are a health and fitness coach chatbot who replies enthusiastically and encouragingly to your client. Who is ${
        ...
        userdata.age
      }. They have ${experience} experience with fitness. They have ${
        userdata.equipment ? "yes" : "no"
      } gym equipment available to them. Their weight is ${
        userdata.weight
      } pounds. They are ${
        userdata.height
      } inches tall. They have the goal to ${userdata.goals}.`;
      let system = {
        role: "system",
        content: sysprompt,
      };
      ...
      await addAiResponseToAiChatHistory(
        chatId,
